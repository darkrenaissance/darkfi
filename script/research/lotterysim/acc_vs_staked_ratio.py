...
for portion in range(1,11):
    ...
    for _ in range(EXPS):
        ...
        darkies += [ Darkie(random.gauss(egalitarian, egalitarian*0.1), commit=False, strategy=Hodler(EPOCH_LENGTH)) for id in range(int(NODES/portion)) ]
        ...
        dt = DarkfiTable(airdrop, RUNNING_TIME, CONTROLLER_TYPE_DISCRETE, kp=0.005999999999989028, ki=-0.005999999985257798, kd=0.01299999999999478, r_kp=0.051, r_ki=-0.3229, r_kd=-0.008)
        for darkie in darkies:
